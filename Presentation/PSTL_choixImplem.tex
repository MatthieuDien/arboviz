...
%    \end{itemize}
	\includegraphics[width=\textwidth]{boiteOutils}
\end{frame}
...
\begin{frame}[fragile, allowframebreaks]
    \frametitle{Sous-langage de DOT}
    \begin{block}{Grammaire respectée}
    \begin{alltt}
...
\begin{frame}[fragile, allowframebreaks]
    \frametitle{Sous-langage de XML}
    \begin{block}{Grammaire respectée}
    \begin{alltt}
...
\begin{frame}[allowframebreaks]
	...
	\lstinputlisting[language=Python, firstline=43, lastline=75]{../Src/tree.py}
\end{frame}
